...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='1522',db='cv')
...
def run():
    ...
    img_path = os.path.join(script_dir, 'Logo', 'RESUM.png')
    img = Image.open(img_path)
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="" style="text-decoration: none; color: #021659;">Jasmine</a></b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            import os
            script_dir = os.path.dirname(os.path.abspath(__file__))
            upload_dir = os.path.join(script_dir, 'Uploaded_Resumes')
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About The Tool - CAREER GUIDANCE PLATFORM**")
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="" style="text-decoration: none; color: grey;">Jasmine</a>  
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Jasmine ! Total %d " % values + " User's Have Used Our Tool : )")                
